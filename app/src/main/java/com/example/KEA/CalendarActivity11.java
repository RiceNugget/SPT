...
/**
 * Is responsible for the backend code behind the eleventh calendar activity display. This display shows the time slots for the assigned by the person who creates
 ...
 */
public class CalendarActivity11 extends AppCompatActivity implements View.OnClickListener {
    private Button saveAndCrosscheck11, goHome1, goHome2, b1, b2, b3, b4, b5, b6, b7, b8, b9, b10, b11, b12, b13, b14, b15, b16, b17, b18, b19, b20, b21, b22, b23, b24, b25, b26, b27, b28, b29, b30, b31, b32, goNext1, goNext2, goPrevious1, goPrevious2;
    ...
    /**
     * this method is called when the CalendarActivity11 is first activated, or in other words when the xml file for the CalendarActivity11 is opened
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calendar11);
        ...
        saveAndCrosscheck11 = findViewById(R.id.saveAndCrosscheck11);
        saveAndCrosscheck11.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.goNext1:
            case R.id.goNext2:
                Intent intent = new Intent(CalendarActivity11.this, CalendarActivity12.class);
            ...
            case R.id.goPrevious2:
                startActivity(new Intent(this, CalendarActivity10.class));
                break;
            case R.id.saveAndCrosscheck11:
    ...
    public void changeButton(Button b, int i) {
       //i is the number of the button, and correlates with the i-1 on the arrayList
        ...
        reference.child(usernameStr).child("10").child("availLists").child(iAltStr).setValue(!timeSlotAvail);
