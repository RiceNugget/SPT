...
/**
 * Is responsible for the backend code behind the third calendar activity display. This display shows the time slots for the assigned by the person who creates
...
public class CalendarActivity3 extends AppCompatActivity implements View.OnClickListener {
    ...
    /**
     * this method is called when the CalendarActivity3 is first activated, or in other words when the xml file for the CalendarActivity3 is opened
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            Log.d("CalendarActivity3", "savedInstanceState is null");
    ...
    public void changeButton(Button b, int i) {
       //i is the number of the button, and correlates with the i-1 on the arrayList
        ...
        reference.child(usernameStr).child("2").child("availLists").child(iAltStr).setValue(!timeSlotAvail);
